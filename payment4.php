...
{
    public const PAYMENT4_EXTERNAL_ENABLED = 'PAYMENT4_EXTERNAL_ENABLED';
    public const PAYMENT4_SANDBOX_MODE = 'PAYMENT4_SANDBOX_MODE';
    public const PAYMENT4_API_KEY = 'PAYMENT4_API_KEY';
    public const MODULE_ADMIN_CONTROLLER = 'AdminConfigurePayment4';
